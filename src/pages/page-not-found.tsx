    ...
    <>
      <div className="absolute top-0 z-[-2] h-screen w-screen bg-neutral-950 bg-[radial-gradient(ellipse_80%_80%_at_50%_-20%,rgba(120,119,198,0.3),rgba(255,255,255,0))]">
        <div className="flex justify-center items-start h-full">
          <div className="py-24 flex-col items-center flex">
            <svg
              fill="none"
              height="167"
              viewBox="0 0 138 167"
            ...
            <div className="flex flex-col justify-center items-center">
              <h1 className="font-semibold text-5xl font-mono mt-3">
                404 | Page Not Found
              </h1>
              <button
                onClick={() => moveback()}
                className="capitalize bg-[#ededed] py-1 px-4 mt-10 text-lg font-medium  rounded-full text-[#454545]"
              >
                Go back
              </button>
            </div>
