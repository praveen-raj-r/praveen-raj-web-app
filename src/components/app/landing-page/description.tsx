const Description = () => {
    return (
      <p className="sm:text-xl text-lg leading-[150%] my-4 mx-1 sm:mx-auto font-light mt-6">
        ...
        that not only function flawlessly but also inspire users. With expertise
        in modern frameworks and a passion for pushing the boundaries of{" "}
        <span className="font-semibold gradient retro-1">
          frontend development
        </span>
        , I aim to bridge the gap between aesthetics and functionality, crafting
